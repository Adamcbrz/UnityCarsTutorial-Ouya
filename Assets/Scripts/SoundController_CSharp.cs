...
public class SoundController_CSharp : MonoBehaviour
{
/////////
// SoundController.js
//
...
//	backgroundMusic.minVolume = BackgroundMusicVolume;
	...
	void  Update ()
	{
		...
		int newGear = Mathf.RoundToInt(pitchFactor);
...
// has been started.
	...
	{
		SoundToggler_CSharp st = coll.transform.GetComponent<SoundToggler_CSharp> ();
		if (st)
